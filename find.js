...
// NLS clickable indexes as overlay layers from GeoServer
    ...
    var catalog_1inch_popular = new ol.layer.Tile({
			...
			typename: 'nls:catalog_1inch_popular',
    			visible: false,	
    			source: new ol.source.XYZ({
      				url: "http://geoserver.nls.uk/geoserver/gwc/service/gmaps?layers=nls:catalog_1inch_popular&zoom={z}&x={x}&y={y}&format=image/png",
  			attributions: '' })   
    });
    ...
    var catalog_1inch_newpop = new ol.layer.Tile({
			...
			typename: 'nls:new_pop_eng_wales',
    			visible: false,	
    			source: new ol.source.XYZ({
      				url: "http://geoserver.nls.uk/geoserver/gwc/service/gmaps?layers=nls:new_pop_eng_wales&zoom={z}&x={x}&y={y}&format=image/png",
  			attributions: '' })   
    });
    ...
    var catalog_1inch_seventh = new ol.layer.Tile({
			...
			typename: 'nls:catalog_one_inch_7th_series',
    			visible: false,	
    			source: new ol.source.XYZ({
      				url: "http://geoserver.nls.uk/geoserver/gwc/service/gmaps?layers=nls:catalog_one_inch_7th_series&zoom={z}&x={x}&y={y}&format=image/png",
  			attributions: '' })   
    });
    ...
    var catalog_6inch = new ol.layer.Tile({
			...
			typename: 'nls:catalog_6inch',
    			visible: false,	
    			source: new ol.source.XYZ({
      				url: "http://geoserver.nls.uk/geoserver/gwc/service/gmaps?layers=nls:catalog_6inch&zoom={z}&x={x}&y={y}&format=image/png",
   			attributions: '' })   
    });
...
// the WFS request to GeoServer
		...
		var urlgeoserver =  'http://geoserver.nls.uk/geoserver/wfs?service=WFS' + 
